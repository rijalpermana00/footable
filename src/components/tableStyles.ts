...
export const defaultTableStyles: TableStyleConfig = {
  ...
  row: {
    base: "p-4",
    hover:
      "bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600",
    striped:
  ...
  pagination: {
    ...
    select:
      "mx-1 text-xs px-3 h-8 text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white",
...
export const beautifulTableStyles: TableStyleConfig = {
  ...
  row: {
    base: "",
    hover:
      "bg-white dark:bg-slate-900 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/30 dark:hover:from-slate-800/50 dark:hover:to-slate-700/30 transition-all duration-200 ease-in-out",
    striped:
  ...
  pagination: {
    ...
    button: {
      ...
      active:
        "bg-blue-600 text-white border-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 shadow-md",
...
export const elegantGlassTableStyles: TableStyleConfig = {
  ...
  row: {
    base: "",
    hover:
      "bg-white/40 dark:bg-slate-900/40 hover:bg-gradient-to-r hover:from-violet-50/60 hover:to-purple-50/40 dark:hover:from-slate-800/60 dark:hover:to-slate-700/40 transition-all duration-300 ease-out backdrop-blur-sm",
    striped:
  ...
  pagination: {
    ...
    select:
      "mx-2 px-4 py-2 text-sm font-medium text-slate-700 bg-white/70 border border-slate-300/50 rounded-xl shadow-lg hover:bg-white/90 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 dark:bg-slate-800/70 dark:border-slate-600/50 dark:text-slate-200 dark:hover:bg-slate-700/90 transition-all duration-200 backdrop-blur-sm",
    ...
    button: {
      ...
      active:
        "bg-gradient-to-r from-violet-600 to-purple-600 text-white border-violet-600 hover:from-violet-700 hover:to-purple-700 shadow-lg dark:from-violet-500 dark:to-purple-500 dark:hover:from-violet-600 dark:hover:to-purple-600",
...
export const vibrantTableStyles: TableStyleConfig = {
  ...
  row: {
    base: "",
    hover:
      "bg-white dark:bg-gray-900 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-gray-800 dark:hover:to-gray-700 transition-all duration-200 transform hover:scale-[1.01]",
    striped:
  ...
  pagination: {
    ...
    select:
      "mx-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border-2 border-purple-300 rounded-xl shadow-md hover:border-purple-500 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-purple-500 dark:bg-gray-800 dark:border-purple-600 dark:text-gray-200 transition-all duration-200",
    list: "inline-flex items-center space-x-1",
    button: {
      ...
      active:
        "bg-gradient-to-r from-purple-600 to-indigo-600 text-white border-purple-600 hover:from-purple-700 hover:to-indigo-700 shadow-lg transform scale-105",
      disabled: "cursor-not-allowed opacity-50 pointer-events-none",
      first: "rounded-l-xl",
      last: "rounded-r-xl",
    },
...
export const modernTableStyles: TableStyleConfig = {
  ...
  row: {
    base: "",
    hover:
      "bg-white border-b border-slate-200 dark:bg-slate-900 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors",
    striped:
